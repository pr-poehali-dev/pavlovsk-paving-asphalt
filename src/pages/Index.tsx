...
export default function Index() {
  const services = [
    ...
    },
    {
      ...
      description: 'Комплексные работы по асфальтированию дорог, парковок и проездов с использованием качественных материалов'
    },
    {
      icon: 'TreePine',
      title: 'Благоустройство территории',
      description: 'Полный комплекс работ по облагораживанию и благоустройству придомовых территорий, парков и скверов'
    }
  ];
  ...
  const portfolio = [
    {
      ...
      description: 'Укладка 2500 м² тротуарной плитки',
      image: '/img/1aa7fafd-728d-4f19-8d3e-bf12c328ab69.jpg'
    },
    {
      title: 'Торговый центр "Павловский"', 
      description: 'Асфальтирование парковки 1200 м²',
      image: '/img/a6f85913-ce90-4581-aa5e-d04e3bc9235b.jpg'
    },
    {
      title: 'Парк культуры и отдыха',
      description: 'Благоустройство территории 5000 м²',
